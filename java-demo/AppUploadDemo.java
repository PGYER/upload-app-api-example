...
public class AppUploadDemo implements AppUploadDemo.ProgressHttpEntityWrapper.ProgressCallback{
    ...
    public static final String  GET_TOKEN_URL = "https://api.xcxwo.com/apiv2/app/getCOSToken";
    ...
    public void uploadApk(){
        ...
        File uploadFile = new File(APP_PATH);//应用文件路径
        // 根据文件扩展名确定buildType
        ...
        if (fileName.endsWith(".ipa")) {
            ...
            throw new IllegalArgumentException("Unsupported file type. Supported types: ipa, apk, hap");
        }
                    ...
                    timers = new Timer(5000, new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            if(timers != null){
                                timers.stop();
                                timers = null;
                                String url = "https://api.xcxwo.com/apiv2/app/buildInfo?_api_key="+apikey+"&buildKey="+buildKey;
